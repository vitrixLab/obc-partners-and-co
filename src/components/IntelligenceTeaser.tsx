...
export default function IntelligenceTeaser() {
  const [selectedReport, setSelectedReport] = useState<
    (typeof intelligenceTeasers)[number] | null
  >(null);
      ...
      >
        ...
        <div className="text-center mb-24 md:mb-32">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#1a1a1a] max-w-3xl mx-auto leading-tight">
            Institutional{' '}
            <span className="text-[#c4a962]">Foresight</span>
          </h2>
          <p className="text-sm md:text-base text-[#6b6b6b] mt-6 max-w-xl mx-auto leading-relaxed">
            Proprietary market intelligence from the OBC atelier. Insights that
            shape real estate strategy.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-8">
                  ...
                  <button
                    ...
                    className="inline-flex items-center text-sm font-medium text-[#c4a962] hover:text-[#b89b4a] transition-colors cursor-pointer mt-auto"
                  >
                    {item.cta}
                    <svg
